...
const uint8_t ascii_it[] PROGMEM = {
    ...
    KEY_NONE,       KEY_Y,          // y
    KEY_NONE,       KEY_Z,          // z
    (KEY_MOD_LSHIFT | KEY_MOD_RALT),   KEY_LEFTBRACE,  // {

    // 124, 0x7c
    KEY_MOD_LSHIFT, KEY_GRAVE,      // |
    (KEY_MOD_LSHIFT | KEY_MOD_RALT),  KEY_RIGHTBRACE, // }
    KEY_NONE,       KEY_NONE,       // ~
    KEY_NONE,       KEY_BCKSPACE,  // DEL
};

const uint8_t extended_ascii_it[] PROGMEM = {
    0xE0, KEY_NONE,         KEY_APOSTROPHE, // à
    0xE0, KEY_NONE,         KEY_BACKSLASH,  // ù
    0xF2, KEY_NONE,         KEY_SEMICOLON,  // ò
    0xE7, KEY_MOD_LSHIFT,   KEY_SEMICOLON,  // ç
    0xE8, KEY_NONE,         KEY_LEFTBRACE,  // è
    0xE9, KEY_MOD_LSHIFT,   KEY_LEFTBRACE,  // é
    0xEC, KEY_NONE,         KEY_EQUAL,      // ì
    0x9c, KEY_MOD_LSHIFT,   KEY_3,          // £
    0xF8, KEY_MOD_LSHIFT,   KEY_APOSTROPHE  // °
};
...
static hid_locale_t locale_it {
    (uint8_t*)ascii_it, sizeof(ascii_it) / 2,
