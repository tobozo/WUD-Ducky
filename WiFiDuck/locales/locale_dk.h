...
// Modifier(s), Key
const uint8_t ascii_dk[] PROGMEM = {
...
const uint8_t utf8_dk[] PROGMEM = {
    ...
    0xC2, 0xBD, 0x00, 0x00, KEY_NONE,               KEY_GRAVE,          // ½
...
const uint8_t combinations_dk[] PROGMEM = {
    0x5E, 0x00, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_SPACE,          // ^
    ...
    0xC3, 0x82, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_A,              // Â
    ...
    0xC3, 0x8A, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_E,              // Ê
    ...
    0xC3, 0x8E, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_I,              // Î
    ...
    0xC3, 0x94, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_O,              // Ô
    ...
    0xC3, 0x9B, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_U,              // Û
    0xC3, 0x9C, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_MOD_LSHIFT,     KEY_U,              // Ü
    0xC3, 0x9D, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_MOD_LSHIFT,     KEY_Y,              // Ý
    0xC3, 0xA0, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_A,              // à
    0xC3, 0xA1, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_A,              // á
    0xC3, 0xA2, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_A,              // â
    0xC3, 0xA4, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_A,              // ä
    0xC3, 0xA8, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_E,              // è
    0xC3, 0xA9, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_E,              // é
    0xC3, 0xAA, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_E,              // ê
    ...
    0xC3, 0xAE, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_I,              // î
    ...
    0xC3, 0xB4, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_O,              // ô
    0xC3, 0xB6, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_O,              // ö
    0xC3, 0xB9, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_EQUAL,          KEY_NONE,           KEY_U,              // ù
    0xC3, 0xBA, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_U,              // ú
    0xC3, 0xBB, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     KEY_NONE,           KEY_U,              // û
    0xC3, 0xBC, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_U,              // ü
    0xC3, 0xBD, 0x00, 0x00, KEY_NONE,               KEY_EQUAL,          KEY_NONE,           KEY_Y,              // ý
    0xC3, 0xBF, 0x00, 0x00, KEY_NONE,               KEY_RIGHTBRACE,     KEY_NONE,           KEY_Y,              // ÿ
};

static hid_locale_t locale_dk {
    (uint8_t*)ascii_dk, 128,
    (uint8_t*)utf8_dk, sizeof(utf8_dk) / 6,
    (uint8_t*)combinations_dk, sizeof(combinations_dk) / 8,
};
