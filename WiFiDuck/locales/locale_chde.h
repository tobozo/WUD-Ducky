...
// Modifier(s), Key
const uint8_t ascii_chde[] PROGMEM = {
...
const uint8_t utf8_chde[] PROGMEM = {
...
const uint8_t combinations_chde[] PROGMEM = {
...
static hid_locale_t locale_chde {
    (uint8_t*)ascii_chde, 128,
    (uint8_t*)utf8_chde, sizeof(utf8_chde) / 6,
    (uint8_t*)combinations_chde, sizeof(combinations_chde) / 8,
};
