...
const uint8_t utf8_fr[] PROGMEM = {
    0xC2, 0xA3, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_RIGHTBRACE,     // £
    0xC2, 0xA4, 0x00, 0x00, KEY_MOD_RALT,           KEY_RIGHTBRACE,     // ¤
    0xC2, 0xA7, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_SLASH,          // §
...
const uint8_t combinations_fr[] PROGMEM = {
    0x60, 0x00, 0x00, 0x00, KEY_MOD_RALT,           KEY_7,              KEY_NONE,           KEY_SPACE,          // `
    0x7E, 0x00, 0x00, 0x00, KEY_MOD_RALT,           KEY_2,              KEY_NONE,           KEY_SPACE,          // ~
    0xC2, 0xA8, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_LEFTBRACE,      KEY_NONE,           KEY_SPACE,          // ¨
    0xC3, 0x80, 0x00, 0x00, KEY_MOD_RALT,           KEY_7,              KEY_MOD_LSHIFT,     KEY_Q,              // À
    0xC3, 0x82, 0x00, 0x00, KEY_NONE,               KEY_LEFTBRACE,      KEY_MOD_LSHIFT,     KEY_Q,              // Â
    0xC3, 0x83, 0x00, 0x00, KEY_MOD_RALT,           KEY_2,              KEY_MOD_LSHIFT,     KEY_Q,              // Ã
    ...
    0xC3, 0x91, 0x00, 0x00, KEY_MOD_RALT,           KEY_2,              KEY_MOD_LSHIFT,     KEY_N,              // Ñ
    ...
    0xC3, 0x95, 0x00, 0x00, KEY_MOD_RALT,           KEY_2,              KEY_MOD_LSHIFT,     KEY_O,              // Õ
    ...
    0xC3, 0xA3, 0x00, 0x00, KEY_MOD_RALT,           KEY_2,              KEY_NONE,           KEY_Q,              // ã
...
static hid_locale_t locale_fr {
    ...
    (uint8_t*)combinations_fr, sizeof(combinations_fr) / 8,
};
